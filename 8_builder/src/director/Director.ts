...
export default class Director{
    ...
    constructSedanCar(){
        ...
        this.builder.setTransmission(Transmission.AUTO);
    ...
    constructTruck(){
        ...
        this.builder.setTransmission(Transmission.AUTO_SEQUENTIAL);
    ...
    constructMotorcycle(){
        ...
        this.builder.setEngine(new Engine(8000));
        this.builder.addWheel(new Wheel(2)) 
    }
